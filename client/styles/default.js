...
export const GRADIENT_COLOR = {
    primary: {
        main: linerGradient('45deg', [
            [THEME_COLOR.primary.main, '30%'],
            [THEME_COLOR.primary.strong, '90%'],
        ]),
        bridge: linerGradient('60deg', [
            [THEME_COLOR.primary.bridge, '30%'],
            [THEME_COLOR.primary.strong, '90%'],
        ]),
    },

    secondary: {
        main: linerGradient('60deg', [
            [THEME_COLOR.secondary.main, '0%'],
            [THEME_COLOR.secondary.bridge, '79%'],
        ]),
        bridge: linerGradient('60deg', [
            [THEME_COLOR.secondary.bridge, '30%'],
            [THEME_COLOR.secondary.strong, '90%'],
        ]),
    },
