...
const SHORT_COMMAND_NAME = '@v/behance'
const DEFAULT_COMMAND_NAME = '@vorlefan/behance'

const START_COMMAND_PATH =
    'node .regula/src/command/behance_project/src/index.js'
